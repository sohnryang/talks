\begin{tikzpicture}[
  ...
  norm/.style={box,fill=yellow!25,draw=olive!60},
  global/.style={box,fill=magenta!18,draw=magenta!60,minimum width=34mm,minimum height=9mm,opacity=0.25,text opacity=0.25},
  ffnn/.style={box,fill=blue!18,draw=blue!50,minimum width=34mm,minimum height=9mm,opacity=0.25,text opacity=0.25},
