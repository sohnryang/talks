...
\begin{tikzpicture}[scale=0.85, line join=round]
  \useasboundingbox (-0.2,-0.2) rectangle (14.2,4.2); % shared, fixed box

  % --- highlights ---
  \fill[blue!18]   (0,2)  rectangle (4,3);   % A row 2
  \fill[red!16]    (6,0)  rectangle (7,4);   % B col 2
  \fill[violet!30] (11,2) rectangle (12,3);  % C_{22}
